...
WebUI.click(findTestObject('Sort/sort'))

WebUI.selectOptionByValue(findTestObject('Sort/sort'), 'za', false)

WebUI.click(findTestObject('Sort/sort'))

WebUI.selectOptionByValue(findTestObject('Sort/sort'), 'az', false)
